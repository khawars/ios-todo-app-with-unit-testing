...
def xcodeproj = 'TodoApp.xcodeproj' // Path to the xcodeproj
def xcarchive_name = "TodoApp.xcarchive" // Name of the archive to build
def build_scheme = 'TodoApp (iOS)' // Scheme to build the app
def test_scheme = 'TodoAppTests' // Scheme to build tests
...
node {
    ...
    def buildURL = "http://localhost:8080//builds/ios"
